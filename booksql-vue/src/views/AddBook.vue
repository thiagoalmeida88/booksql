<template>
  <div class="create container mt-12 bg-white rounded-t-lg overflow-hidden border-t border-l border-r border-gray-400 p-4 flex p-8">
    <form class="w-full max-w-full" action="#" method="POST" @submit.prevent="addBook">
      <h1 class="mb-8">Create Book</h1>  
      ...
      <!-- <div class="w-full mb-6">
        <div class="md:w-1/3"></div>
        <label class="md:w-2/3 block text-gray-700 font-bold" for="featured">
          <input class="mr-2 leading-tight" type="checkbox" name="featured" v-model="featured">
          <span class="text-sm">
            Featured
          </span>
        </label>
      ...
      <div class="flex flex-wrap -mx-3 mb-2">    
        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
          <label class="block uppercase tracking-wide text-xs font-bold mb-2" for="category">
            Category
          </label>
          <div class="relative">
